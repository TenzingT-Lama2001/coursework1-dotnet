...
public static class Utils
{
    ...
    {
        return @"E:\Year3\Sem1\Coursework\net\Coursework\Coursework\wwwroot\";
    }
    ...
    public static string GetInventoryDetailsFilePath()
    {
        return Path.Combine(GetAppDirectoryPath() + "inventoryDetails.json");
    }
}
